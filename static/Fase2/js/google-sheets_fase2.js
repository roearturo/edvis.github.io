...
$("#ideasPrevias").keypress(function(e) {//Para deshabilitar el uso de la tecla "Enter"
        if (e.which == 13) {
        return false;
        }
});
...
$("#ideasPrevias").submit(function(event){
    ...
    request = $.ajax({
        url: "https://script.google.com/macros/s/AKfycbygBH8_c_QzHoCv4XeGgQB3PbaOqCV6fRCwSBhTQt_YDR2wEsI/exec",
        type: "post",
        data: serializedData
    });
