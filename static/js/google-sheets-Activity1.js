...
$("#Actividad_1").submit(function(event){
    ...
    serializedData=serializedData+"&Tabla="+dataArr+"&Cuanta ayuda="+dataArr2;
    ...
    request = $.ajax({
        url: "https://script.google.com/macros/s/AKfycbxrBo5xyJKAHEtAnJ_udvke1xg4KGT9Ys2vC9FoWKd_4LJbNcJB/exec",
        type: "post",
        data: serializedData
    });
