...
$("#Actividad_3a").keypress(function(e) {//Para deshabilitar el uso de la tecla "Enter"
        if (e.which == 13) {
        return false;
        }
});
...
$("#Actividad_3a").submit(function(event){
    var dataArr = [];
    $("td").each(function(){
    ...
    serializedData=serializedData+"&Sketch_1="+data_1+"&Sketch_2="+data_2+"&Tabla="+dataArr;
    ...
    request = $.ajax({
        url: "https://script.google.com/macros/s/AKfycby2_VV7LcCO-4ujqH0HUKnnV9apAUk2rEqiXyObdaYt_KKzH0-a/exec",
        type: "post",
        data: serializedData
    });
